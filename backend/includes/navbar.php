...
if(isset($_SESSION['verified_user_id'])) {
    ...
    $storeToken = isset($storeInfo['store_token']) ? $storeInfo['store_token'] : '';
...
<nav class="navbar navbar-expand-lg <?php echo $navbarClass; ?>" style="background-color: <?php echo $primaryColor; ?>;">
    <div class="container">
        <a class="navbar-brand" href="mystore.php?store=<?php echo isset($storeInfo['store_token']) ? $storeInfo['store_token'] : ''; ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <?php else : ?>
                    <li class="nav-item">
                        <a class="nav-link" href="mystore.php?store=<?php echo $storeToken; ?>">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?store=<?php echo $storeToken; ?>">Marketplace</a>
                    </li>
                    <li class="nav-item">
